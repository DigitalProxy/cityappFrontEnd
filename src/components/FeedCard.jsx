...
>>>>>>> 2dc2b12584610994feccdda7f877e69377162d00
          return (
            <div>
...
<circle cx="7.34029" cy="7.17537" r="0.742268" fill="white"/>
              ...
              <br />
              <Link to="/comment"><svg style={spacing} width="40" height="25" viewBox="0 0 40 14" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M29.36 9.69V12H21.575V9.69H24.02V5.025H21.575V3.285C22.245 3.245 22.995 3.07 23.825 2.76C24.655 2.44 25.38 2.075 26 1.665H27.005V9.69H29.36ZM35.1949 1.5C36.0049 1.5 36.7049 1.63 37.2949 1.89C37.8949 2.14 38.3549 2.5 38.6749 2.97C39.0049 3.44 39.1699 3.985 39.1699 4.605C39.1699 5.185 39.0249 5.71 38.7349 6.18C38.4449 6.65 38.0799 7.065 37.6399 7.425C37.1999 7.785 36.5949 8.225 35.8249 8.745C35.3949 9.025 35.0449 9.265 34.7749 9.465H39.2899V12H30.7399V11.28C30.7399 10.75 30.8599 10.28 31.0999 9.87C31.3499 9.45 31.7099 9.03 32.1799 8.61C32.6599 8.19 33.3499 7.62 34.2499 6.9C34.9699 6.33 35.4749 5.895 35.7649 5.595C36.0549 5.295 36.1999 5 36.1999 4.71C36.1999 4.4 36.0899 4.14 35.8699 3.93C35.6599 3.72 35.3399 3.615 34.9099 3.615C34.4599 3.615 34.1049 3.745 33.8449 4.005C33.5849 4.265 33.4549 4.605 33.4549 5.025V5.325H30.7849C30.7749 5.245 30.7699 5.135 30.7699 4.995C30.7699 3.915 31.1449 3.065 31.8949 2.445C32.6549 1.815 33.7549 1.5 35.1949 1.5Z" fill="#1F1F1F"/>
...
<rect y="11.8789" width="6.26087" height="2.12121" fill="#1F1F1F"/>
              ...
              <br />
              <Link style={linkStyle} to="/share"><strong>SHARE</strong> </Link>
              </div>
