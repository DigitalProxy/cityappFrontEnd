            ...
            <div style={titleStyle2}>
              <div>
                ...
                >
                  ...
                  <path
                    d="M14.4255 7.02567C8.71903 7.06777 4.02916 11.9192 2.39197 14.3501C4.02916 16.7811 8.71903 21.6325 14.4255 21.6746C20.1319 21.6325 24.8218 16.7811 26.459 14.3501C24.8218 11.9192 20.1319 7.06777 14.4255 7.02567Z"
                    fill="white"
                  />
                  <circle cx="14.5" cy="14.4999" r="4.93299" fill="#FFB0B0" />
                  <path
                    d="M19.433 14.4999C19.433 15.4755 19.1437 16.4293 18.6016 17.2405C18.0596 18.0517 17.2892 18.684 16.3878 19.0574C15.4864 19.4307 14.4945 19.5284 13.5376 19.3381C12.5807 19.1477 11.7017 18.6779 11.0119 17.988C10.322 17.2981 9.85214 16.4192 9.6618 15.4623C9.47146 14.5054 9.56915 13.5135 9.94252 12.6121C10.3159 11.7107 10.9482 10.9403 11.7594 10.3983C12.5706 9.85621 13.5244 9.56689 14.5 9.56689V14.4999H19.433Z"
                    fill="#CE2E4A"
                  />
                  <path
                    d="M17.9882 17.988C18.4462 17.53 18.8096 16.9862 19.0575 16.3877C19.3054 15.7892 19.433 15.1477 19.433 14.4999H14.5L17.9882 17.988Z"
                    fill="#FF5F5F"
                  />
                  <circle
                    cx="14.4999"
